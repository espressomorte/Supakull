...
SET DEFINE OFF;
Insert into DOFER.TASKMAIN (TK_ID,TK_SUMMARY,TK_DESCRIPTION,TK_SUB_TYPE,TK_STATUS,TK_PRIORITY,TK_PRODUCT,TK_PROJECT,TK_CR_DATE,TK_CR_BY,TK_LINK_TO_TRACKER,TK_TARG_VERSION,TK_ESTIMATION,TK_COMENTS,TK_PARENT) values ('1','xzc','sdv','zczv','sdvsdv','svsdv',null,'sdvsdv','sdvsdv','sddvsdv','sdvcsdv','sdvsv','sdv','adsfdf',null);
Insert into DOFER.TASKMAIN (TK_ID,TK_SUMMARY,TK_DESCRIPTION,TK_SUB_TYPE,TK_STATUS,TK_PRIORITY,TK_PRODUCT,TK_PROJECT,TK_CR_DATE,TK_CR_BY,TK_LINK_TO_TRACKER,TK_TARG_VERSION,TK_ESTIMATION,TK_COMENTS,TK_PARENT) values ('2','adsc','hdgsvc','hdvh','shvyhdshg','udhvsyusdhv','uhdvuhdsv','udhvuysdhv','hdvhsdvh','hdvhhshv','hduvhshv','hdhvudshv','duhvush','ssduhvushv','1');
REM INSERTING into DOFER.TASKMAIN_TO_USER
SET DEFINE OFF;
Insert into DOFER.TASKMAIN_TO_USER (TK_ID,US_ID) values ('1','2');
Insert into DOFER.TASKMAIN_TO_USER (TK_ID,US_ID) values ('2','1');
