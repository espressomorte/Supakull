...
DROP TABLE "DISAGREEMENT" cascade constraints;
...
ALTER TABLE "DISAGREEMENT" MODIFY ("DA_TK_ID" NOT NULL ENABLE);
ALTER TABLE "DISAGREEMENT" MODIFY ("DA_FIELDNAME" NOT NULL ENABLE);
ALTER TABLE "DISAGREEMENT" ADD CONSTRAINT "DISAGREEMENT" FOREIGN KEY ("DA_TK_ID")
	  REFERENCES "TASKMAIN" ("TK_ID") ENABLE;
