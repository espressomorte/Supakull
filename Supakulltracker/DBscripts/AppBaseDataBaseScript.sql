...
--------------------------------------------------------
  ...
  CREATE TABLE "PlaceHolderForSchemaName"."TASKMAIN" 
   (	"TK_ID" NUMBER, 
	"TK_TASKID" VARCHAR2(50 BYTE), 
	"TK_SUMMARY" VARCHAR2(1000 BYTE), 
	"TK_DESCRIPTION" VARCHAR2(1000 BYTE), 
	"TK_SUB_TYPE" VARCHAR2(50 BYTE), 
	"TK_STATUS" VARCHAR2(50 BYTE), 
	"TK_PRIORITY" VARCHAR2(50 BYTE), 
	"TK_PRODUCT" VARCHAR2(50 BYTE), 
	"TK_PROJECT" VARCHAR2(50 BYTE), 
	"TK_CR_DATE" VARCHAR2(50 BYTE), 
	"TK_CR_BY" VARCHAR2(50 BYTE), 
	"TK_LINK_TO_TRACKER" VARCHAR2(200 BYTE), 
	"TK_TARG_VERSION" VARCHAR2(50 BYTE), 
	"TK_ESTIMATION" VARCHAR2(50 BYTE), 
	"TK_COMENTS" VARCHAR2(2000 BYTE), 
	"TK_PARENT" VARCHAR2(50 BYTE), 
	"TK_TOKEN_ID" NUMBER,
	"TK_SOURCE" VARCHAR2(50 BYTE)
   ) ;
--------------------------------------------------------
