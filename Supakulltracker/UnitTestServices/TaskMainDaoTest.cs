...
namespace UnitTestServices
{
    ...
    public class TaskMainDaoTest
    {
        ...
        public void SaveOrUpdateCollectionInDB_Test1()
        {
            ...
            TaskMainDAO taskMainDAO1 = new TaskMainDAO() { TaskID = "Task11", Source = Sources.DataBase };
            TaskMainDAO taskMainDAO2 = new TaskMainDAO() { TaskID = "Task11", Source = Sources.Excel };
            TaskMainDAO taskMainDAO3 = new TaskMainDAO() { TaskID = "Task13", Source = Sources.DataBase };
            TaskMainDAO taskMainDAO4 = new TaskMainDAO() { TaskID = "Task13", Source = Sources.Excel };
        ...
        public void SaveOrUpdateCollectionInDB_Test2()
        {
            ...
            ITask taskMainParent1 = new TaskMain() { TaskID = "TaskParent1", Source = Sources.DataBase };
            ITask taskMainParent2 = new TaskMain() { TaskID = "TaskParent1", Source = Sources.Trello };
